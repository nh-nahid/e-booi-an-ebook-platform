    ...
    <div className="flex flex-col gap-3 rounded-2xl border border-[#E1E5E8] bg-white p-4 sm:flex-row sm:items-center">
      <div className="relative flex-1">
        ...
        <input
          ...
          className="
            h-10 w-full rounded-full border border-[#E1E5E8] bg-[#F7F9FA] pl-10 pr-4 text-sm
            text-[#0A0E2A] outline-none transition-all duration-200
            placeholder:text-[#9AA3AF]
            focus:border-[#2DBDB6] focus:bg-white focus:shadow-[0_0_0_4px_rgba(45,189,182,0.15)]
          "
        />
      </div>
