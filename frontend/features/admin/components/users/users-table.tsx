...
import ViewUserDialog, { type UserDetails } from "./view-user-dialog";
...
interface UsersTableProps {
  ...
  onDelete?: (user: UserDetails) => Promise<void> | void;
}
    ...
    <div className="rounded-2xl border border-[#E1E5E8] bg-white p-5">
      <div className="mb-4 flex items-center justify-between">
        <p className="text-sm text-[#6B7280]">
          Showing <span className="font-semibold text-[#0A0E2A]">{users.length}</span> of{" "}
          <span className="font-semibold text-[#0A0E2A]">{total}</span> users
        </p>
      </div>
            ...
            {users.map((user) => {
              ...
              return (
                ...
                >
                  <td className="py-3 pr-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <p className="truncate font-semibold text-[#0A0E2A]">{user.name}</p>
                  ...
                  <td className="py-3 pr-4 text-xs text-[#9AA3AF]">{user.joinedAt}</td>
