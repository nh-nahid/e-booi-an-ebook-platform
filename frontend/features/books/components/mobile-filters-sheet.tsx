    ...
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      <div className="absolute inset-y-0 left-0 w-[85%] max-w-sm animate-in slide-in-from-left duration-300">
        <div className="flex h-full flex-col overflow-y-auto bg-[#F7F9FA] p-4">
          ...
          <BooksFilters filters={filters} onChange={onChange} onClear={onClear} />

          <button
            onClick={onClose}
            className="
              mt-4 h-11 w-full rounded-full border-0 bg-gradient-to-br from-[#2DBDB6] to-[#1f9d97]
              text-sm font-bold text-white shadow-[0_4px_12px_rgba(45,189,182,0.35)]
            "
          >
            Show Results
          </button>
